...
import { L as Ie, s as X, a as Te, f as Ne } from "../chunks/D_MrbdsC.js";
import { b as ve } from "../chunks/BPnHVCzW.js";
import { w as Me, p as Pt, x as Pe, u as Y, __tla as __tla_0 } from "../chunks/C-Z7SKhz.js";
...
Make sure your charset is UTF-8`);
  ...
  function Ye() {
    return xt || (xt = 1, function(o) {
      const r = z(), i = He(), e = Ke(), t = Je(), n = je(), s = fe(), a = k(), u = Oe();
      function c(A) {
 ...
 Suggested mode is: ` + r.toString(B));
  ...
  function Ge() {
    if (Xt) return et;
    Xt = 1;
    const o = k(), r = It(), i = be(), e = Le(), t = _e(), n = De(), s = qe(), a = ce(), u = ke(), c = ze(), l = Ve(), f = z(), m = Ye();
    function d(h, E) {
...
`;
  ...
  var Ze = We();
  const xe = Me(Ze);
  var Xe = oe('<div class="flex flex-row justify-center flex-grow w-full h-full"><div class="inline-block h-6 w-6 animate-spin"><!></div></div> <canvas></canvas>', 1);
  function tn(o, r) {
    se(r, true);
    ...
    var n = Xe(), s = Ce(n), a = U(s), u = U(a);
    Ie(u, {}), F(a), F(s);
    var c = ue(s, 2);
    let l;
    ve(c, (f) => x(e, f), () => K(e)), At((f) => {
      s.hidden = !K(t), X(c, "title", r.text), l = Te(c, 1, "w-full h-full", null, l, f), X(c, "width", i()), X(c, "height", i()), Ne(c, `width:${i() ?? ""}px;height:${i() ?? ""}px;`);
    }, [
      () => ({
        hidden: K(t)
      })
  ...
  var en = oe('<div class="container mx-auto p-4"><div class="card flex flex-col"><div><h1> </h1></div> <div class="flex flex-row justify-center"><!></div></div></div>');
  dn = function(o, r) {
    se(r, true);
    let i = Ee(() => Y.username && Y.documentId ? `${Pe()}/sync?username=${encodeURIComponent(Y.username)}&userDocumentId=${encodeURIComponent(Y.documentId)}` : null);
    var e = en();
    Ae((f) => {
      At((m) => ye.title = m, [
        () => Pt()
