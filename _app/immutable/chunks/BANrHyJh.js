...
import { H as fe, S as Se, R as Ee } from "./CYgJF_JY.js";
...
window.fetch = (e, t) => ((e instanceof Request ? e.method : (t == null ? void 0 : t.method) || "GET") !== "GET" && H.delete(Ie(e)), St(e, t));
...
const U = ((_a = globalThis.__sveltekit_18pn28u) == null ? void 0 : _a.base) ?? "/ts-duckduckfit", Ct = ((_b = globalThis.__sveltekit_18pn28u) == null ? void 0 : _b.assets) ?? U, Ot = "1742661383417", Ye = "sveltekit:snapshot", ze = "sveltekit:scroll", Je = "sveltekit:states", Nt = "sveltekit:pageurl", B = "sveltekit:history", Y = "sveltekit:navigation", j = { tap: 1, hover: 2, viewport: 3, eager: 4, off: -1, false: -1 }, Z = location.origin;
function Xe(e) {
...
function re(e) {
  return e instanceof fe || e instanceof Se ? e.status : 500;
}
function Jt(e) {
...
let y = { branch: [], error: null, url: null }, Pe = false, ie = false, Me = true, X = false, G = false, at = false, xe = false, ot, k, I, $;
const W = /* @__PURE__ */ new Set();
async function Rn(e, t, n) {
  var _a3, _b2, _c2, _d2;
  document.URL !== location.href && (location.href = location.href), v = e, await ((_b2 = (_a3 = e.hooks).init) == null ? void 0 : _b2.call(_a3)), Te = xt(e), C = document.documentElement, Ae = t, ke = e.nodes[0], ae = e.nodes[1], ke(), ae(), k = (_c2 = history.state) == null ? void 0 : _c2[B], I = (_d2 = history.state) == null ? void 0 : _d2[Y], k || (k = I = Date.now(), history.replaceState({ ...history.state, [B]: k, [Y]: I }, ""));
  const r = D[k];
...
async function te({ type: e, url: t, popped: n, keepfocus: r, noscroll: a, replace_state: s, state: i = {}, redirect_count: o = 0, nav_token: c = {}, accept: l = qe, block: u = qe }) {
  ...
  if (!m) {
    ...
    m = await dt(t, { id: null }, await q(new Se(404, "Not Found", `Not found: ${t.pathname}`), { url: t, params: {}, route: { id: null } }), 404);
  }
...
function gn() {
  ...
  history.scrollRestoration = "manual", addEventListener("beforeunload", (t) => {
    ...
    if ((_a4 = t.state) == null ? void 0 : _a4[B]) {
      ...
      if (i === I && (at || o)) {
        a !== S.state && (S.state = a), e(s), D[k] = Ue(), r && scrollTo(r.x, r.y), k = n;
        return;
      }
      const l = n - k;
