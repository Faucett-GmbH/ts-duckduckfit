import { S as m, C as O, D as R, F as d, G as K, m as b, U as a, v, I as h, J as L, K as M, L as S, M as T } from "./Bvg94FyY.js";
function g(s, x = null, j) {
  if (typeof s != "object" || s === null || m in s) return s;
  const I = S(s);
  if (I !== O && I !== R) return s;
  var f = /* @__PURE__ */ new Map(), c = T(s), _ = d(0);
  c && f.set("length", d(s.length));
  var l;
  return new Proxy(s, { defineProperty(n, e, t) {
    (!("value" in t) || t.configurable === false || t.enumerable === false || t.writable === false) && M();
    var r = f.get(e);
    ...
    if (t !== void 0 || L !== null && (!r || ((_a = h(n, e)) == null ? void 0 : _a.writable))) {
    ...
    var P = Reflect.getOwnPropertyDescriptor(n, e);
    if ((P == null ? void 0 : P.set) && P.set.call(r, t), !u) {
      if (c && typeof e == "string") {
        var N = f.get("length"), w = Number(e);
        Number.isInteger(w) && w >= N.v && v(N, w + 1);
      }
      D(_);
    }
    return true;
