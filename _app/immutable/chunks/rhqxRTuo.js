...
import { l as ls, v as ft, aS as Gi, m as dt, N as ds, o as Yi } from "./DjXzb9G0.js";
import { a as Xi } from "./BGOAb-lb.js";
import { g as Q } from "./KzIwl7iM.js";
import { p as $e } from "./CLjcMQip.js";
let Ha, Eh, kh, pa, ka, ba, Ea, Ta, oa, xa, Ah, Ca, Ma, aa, Ch, Th, xr, ha, za, wa, st, Oh, Ka, Ih, En, Zn, Da, $a, Pa;
let __tla = (async () => {
  ...
  let Zi, Qi, ea, ta, na, ra, sa, ia, ca, ua, fa, la, da, _a, An, ga, ya, ma, va, Sa, Aa, Ia, Oa, Ra, ja, Ua, Ba, Fa, La, Na, Va, wr;
  Zi = true;
  Qi = Zi;
  ea = () => "Application";
  ...
  An = (t = {}, e = {}) => (e.locale ?? Q()) === "en" ? _a() : "errors_message_application";
  ga = () => "Sign in";
  ...
  globalThis.__sveltekit_1jg38qa.env;
  function Wa(t) {
  ...
  const Be = Symbol.for("_am_meta"), Qe = Symbol.for("_am_trace"), et = Symbol.for("_am_objectId"), Gt = Symbol.for("_am_isProxy"), _s = Symbol.for("_am_clearCache"), Ga = Symbol.for("_am_uint"), Ya = Symbol.for("_am_int"), Xa = Symbol.for("_am_f64"), gs = Symbol.for("_am_counter"), Za = Symbol.for("_am_text");
  class Re {
    constructor(e) {
    ...
    set(e, n) {
      if (this[Be]) throw new RangeError("object cannot be modified outside of a change block");
      this.elems[e] = n;
    }
    insertAt(e, ...n) {
      if (this[Be]) throw new RangeError("object cannot be modified outside of a change block");
  ...
  function Yt(t, e) {
    var n, r;
    return t instanceof Date ? false : !!(t && ((r = (n = t[Be]) === null || n === void 0 ? void 0 : n.handle) === null || r === void 0 ? void 0 : r.__wbg_ptr) === e.__wbg_ptr);
  }
  const tc = {
    get(t, e) {
      const { context: n, objectId: r, cache: s } = t;
      return e === Symbol.toStringTag ? t[Symbol.toStringTag] : e === et ? r : e === Gt ? true : e === Qe ? t.trace : e === Be ? {
        handle: n,
        textV2: t.textV2
      } : (s[e] || (s[e] = _e(t, e)), s[e]);
    },
    ...
    get(t, e) {
      const { context: n, objectId: r } = t;
      return e = ke(e), e === Symbol.hasInstance ? (s) => Array.isArray(s) : e === Symbol.toStringTag ? t[Symbol.toStringTag] : e === et ? r : e === Gt ? true : e === Qe ? t.trace : e === Be ? {
        handle: n
      ...
      switch (c) {
        ...
        case "text": {
          if (i) Nt(a), e >= r.length(s) ? r.insertObject(s, e, a) : r.putObject(s, e, a);
            ...
            let u;
            Gn(a), e >= r.length(s) ? u = r.insertObject(s, e, "") : u = r.putObject(s, e, ""), _t(r, u, [
              ...o,
              e
            ]).splice(0, 0, ...a);
          }
    ...
    return {
      ...
      fill(i, a, c) {
        ...
        for (let d = a; d < Math.min(c, l); d++) if (f === "list" || f === "map") e.putObject(n, d, u);
          ...
          Gn(u);
          const h = e.putObject(n, d, ""), g = _t(e, h, [
            ...r,
            d
          ]);
      ...
      splice(i, a, ...c) {
        ...
        for (const [l, d] of f) {
          switch (d) {
            ...
            case "map": {
              const h = e.insertObject(n, i, {}), g = xt(e, h, s, [
                ...r,
                i
              ]);
  ...
  function ic() {
    if (!Et && (Et = typeof crypto < "u" && crypto.getRandomValues && crypto.getRandomValues.bind(crypto), !Et)) throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");
    return Et(oc);
  }
  ...
  function yc(t, e) {
    return gt(Xn(e), "from", {}, (n) => Object.assign(n, t)).newDoc;
  }
  function bc(t, e, n) {
    ...
    try {
      ...
      };
      {
        ...
        return o.handle.integrate(), {
          newDoc: St(t, e, i, n.patchCallback || o.patchCallback),
          newHeads: c != null ? [
            c
          ] : null
        };
  ...
  function wc(t, e) {
    ...
    return n.handle.emptyChange(e.message, e.time), St(t, "emptyChange", r);
  }
  function vc(t, e) {
  ...
  function xs(t, e, n) {
    ...
    return r.handle.loadIncremental(e), St(t, "loadIncremental", s, n.patchCallback || r.patchCallback);
  }
  function Ss(t) {
  ...
  function xc(t, e) {
    ...
    return n.handle.applyChanges(o), St(t, "merge", r, n.patchCallback);
  }
  function Sc(t, e, n) {
  ...
  function Ec(t, e, n, r) {
    ...
    return [
      St(t, "receiveSyncMessage", i, r.patchCallback || o.patchCallback),
      a,
      null
    ];
  }
  ...
  const Is = ".", Lc = "", Cs = "", zc = "#", Nc = "*", Os = "xstate.init", Tn = "xstate.stop";
  function Vc(t, e) {
    return {
  ...
  function fu(t) {
    ...
    if (t.config.on) for (const n of Object.keys(t.config.on)) {
      ...
      e.set(n, Ge(r).map((s) => He(t, n, s)));
    }
    if (t.config.onDone) {
      const n = `xstate.done.state.${t.id}`;
      e.set(n, Ge(t.config.onDone).map((r) => He(t, n, r)));
    }
    for (const n of t.invoke) {
      if (n.onDone) {
        const r = `xstate.done.actor.${n.id}`;
        e.set(r, Ge(n.onDone).map((s) => He(t, r, s)));
      }
      if (n.onError) {
        const r = `xstate.error.actor.${n.id}`;
        e.set(r, Ge(n.onError).map((s) => He(t, r, s)));
      }
      if (n.onSnapshot) {
        const r = `xstate.snapshot.${n.id}`;
        e.set(r, Ge(n.onSnapshot).map((s) => He(t, r, s)));
      }
    }
...
${o.message}`);
  ...
  function Br(t) {
    const e = Hs(t);
    for (const n of e) for (const r of kt(n, t)) e.add(r);
    return e;
  }
  function Hs(t) {
  ...
  function bu(t) {
    const [e, ...n] = t;
    for (const r of kt(e, void 0)) if (n.every((s) => Pe(s, r))) return r;
  }
  function ir(t, e) {
    if (!t.target) return [];
    const n = /* @__PURE__ */ new Set();
    for (const r of t.target) if (ze(r)) if (e[r.id]) for (const s of e[r.id]) n.add(s);
  ...
  function Un(t, e, n, r, s, o) {
    ...
    const c = Ls(t, i, a);
    let u = e;
    s || ([u, a] = Su(u, r, n, c, i, a, o, n.actionExecutor)), u = rt(u, r, n, c.flatMap((l) => l.actions), o, void 0), u = vu(u, r, n, c, i, o, a, s);
    const f = [
      ...i
    ];
    u.status === "done" && (u = rt(u, r, n, f.sort((l, d) => d.order - l.order).flatMap((l) => l.exit), o, void 0));
    try {
      return a === e.historyValue && mu(e._nodes, i) ? u : Ve(u, {
        _nodes: f,
        historyValue: a
      });
    } catch (l) {
  ...
  function xu(t, e, n, r) {
    for (const s of t) {
      const o = zs(s, e);
      for (const a of s.target || []) !ze(a) && (s.source !== a || s.source !== o || s.reenter) && (r.add(a), n.add(a)), Xe(a, e, n, r);
      const i = ir(s, e);
      for (const a of i) {
        const c = kt(a, o);
  ...
  function Xe(t, e, n, r) {
    ...
    if (ze(t)) if (e[t.id]) {
      ...
      ze(s) || (r.add(s), n.add(s)), Xe(s, e, n, r), fn(s, t, r, e, n);
    } else if (t.type === "parallel") for (const s of tt(t).filter((o) => !ze(o))) [
      ...r
    ].some((o) => Pe(o, s)) || (ze(s) || (r.add(s), n.add(s)), Xe(s, e, n, r));
  }
  function Ns(t, e, n, r, s) {
    for (const o of r) if ((!s || Pe(o, s)) && t.add(o), o.type === "parallel") for (const i of tt(o).filter((a) => !ze(a))) [
      ...t
  ...
  function ln(t, e, n, r) {
    ...
    if (e.type === Tn) return s = Ve(Pr(s, e, n), {
      status: "stopped"
    }), i(s, e, []), {
      snapshot: s,
      microstates: o
  ...
  function Pr(t, e, n) {
    return rt(t, e, n, Object.values(t.children).map((r) => Us(r)), [], void 0);
  }
  function Fr(t, e) {
  ...
  function Au(t, e) {
    ...
    for (const s of r) e: for (const o of [
      s
    ].concat(kt(s, void 0))) if (o.always) {
  ...
  class ar {
    ...
    _initialize() {
      this.transitions = fu(this), this.config.always && (this.always = Ge(this.config.always).map((e) => He(this, Cs, e))), Object.keys(this.states).forEach((e) => {
    ...
    get definition() {
      return {
        ...
        initial: this.initial ? {
          ...
          source: this,
          actions: this.initial.actions.map(at),
          eventType: null,
          reenter: false,
          toJSON: () => ({
        ...
        transitions: [
          ...
          ...e,
          actions: e.actions.map(at)
        })),
        entry: this.entry.map(at),
        exit: this.exit.map(at),
        meta: this.meta,
        order: this.order || -1,
        output: this.output,
        invoke: this.invoke,
    ...
    get invoke() {
      return qe(this, "invoke", () => Te(this.config.invoke).map((e, n) => {
    ...
    get after() {
      return qe(this, "delayedTransitions", () => uu(this));
    }
    get initial() {
      return qe(this, "initial", () => lu(this, this.config.initial));
    }
    next(e, n) {
      const r = n.type, s = [];
      let o;
      const i = qe(this, `candidates-${r}`, () => cu(this, r));
      for (const a of i) {
...
${l.message}`);
  ...
  class cr {
    ...
    resolveState(e) {
      const n = Eu(this.root, e.value), r = Vt(qt(this.root, n));
      return Ut({
        _nodes: [
          ...r
        ],
    ...
    getInitialSnapshot(e, n) {
      const r = Ts(n), s = [], o = this.getPreInitialState(e, r, s), i = Un([
        {
          target: [
            ...Hs(this.root)
          ],
    ...
    getStateNodeById(e) {
      const n = Qn(e), r = n.slice(1), s = nn(n[0]) ? n[0].slice(Lu.length) : n[0], o = this.idMap.get(s);
  ...
  var dn = {}, ct = {}, zr;
  function qu() {
    return zr || (zr = 1, Object.defineProperty(ct, "__esModule", {
      value: true
    }), ct.crypto = void 0, ct.crypto = typeof globalThis == "object" && "crypto" in globalThis ? globalThis.crypto : void 0), ct;
  }
  var Nr;
  function Ks() {
  ...
  var _n, Kr;
  function Yu() {
    return Kr || (Kr = 1, _n = Gu()("123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz")), _n;
  }
  var gn, Jr;
  function Xu() {
    if (Jr) return gn;
  ...
  const Js = Zn(Qu), ur = "automerge:", fr = (t) => {
    ...
    const e = t instanceof Uint8Array || typeof t == "string" ? t : "documentId" in t ? t.documentId : void 0, n = e instanceof Uint8Array ? Bn(e) : typeof e == "string" ? e : void 0;
  ...
  }, Ys = (t) => Js.decodeUnsafe(t), Bn = (t) => Js.encode(t), yn = (t) => {
  ...
  let U, Ne, S = 0;
  const rf = 105, sf = 57342, of = 57343, Yr = 57337, Xr = 6, Ke = {};
  let ut = 11281e4, Ce = 1681e4, W = {}, ee, Kt, Jt = 0, yt = 0, re, ge, te = [], Fn = [], fe, ie, lt, Zr = {
    useRecords: false,
    mapsAsObjects: true
  }, bt = false, Xs = 2;
  try {
  ...
  class mt {
    ...
    decode(e, n) {
      if (U) return to(() => (Nn(), this ? this.decode(e, n) : mt.prototype.decode.call(Zr, e, n)));
      Ne = n > -1 ? n : e.length, S = 0, yt = 0, Kt = null, re = null, U = e;
      try {
      ...
      if (this instanceof mt) {
        if (W = this, fe = this.sharedValues && (this.pack ? new Array(this.maxPrivatePackedValues || 16).concat(this.sharedValues) : this.sharedValues), this.structures) return ee = this.structures, Ct();
        (!ee || ee.length > 0) && (ee = []);
    ...
    decodeMultiple(e, n) {
      ...
      try {
        ...
        if (n) {
          if (n(i) === false) return;
          for (; S < o; ) if (s = S, n(Ct()) === false) return;
        } else {
          for (r = [
            i
          ]; S < o; ) s = S, r.push(Ct());
  ...
  function Ct() {
    try {
      ...
      if (S == Ne) ee = null, U = null, ge && (ge = null);
      else if (S > Ne) {
        let e = new Error("Unexpected end of CBOR data");
        throw e.incomplete = true, e;
      } else if (!bt) throw new Error("Data read, but end of buffer not reached");
      return t;
    } catch (t) {
  ...
  function q() {
      ...
      case 31:
        switch (e) {
          ...
          case 4:
            let n = [], r, s = 0;
            for (; (r = q()) != Ke; ) {
              if (s >= ut) throw new Error(`Array length exceeds ${ut}`);
              n[s++] = r;
            }
          ...
          case 5:
            ...
            if (W.mapsAsObjects) {
              ...
              lt && (W.mapsAsObjects = true, lt = false);
    ...
    switch (e) {
      ...
      case 2:
        return uf(t);
      case 3:
        if (yt >= S) return Kt.slice(S - Jt, (S += t) - Jt);
        if (yt == 0 && Ne < 140 && t < 32) {
        ...
        return af(t);
      case 4:
        if (t >= ut) throw new Error(`Array length exceeds ${ut}`);
        let n = new Array(t);
        for (let s = 0; s < t; s++) n[s] = q();
        return n;
      case 5:
        if (t >= Ce) throw new Error(`Map size exceeds ${ut}`);
        if (W.mapsAsObjects) {
          let s = {};
      ...
      case 6:
        if (t >= Yr) {
          ...
          if (t < 65536) {
            ...
            if (W.getShared && (dr(), s = ee[t & 8191], s)) return s.read || (s.read = Hn(s)), s.read();
          }
        }
        let r = te[t];
  ...
  function Ln(t) {
    ...
    if (t > 64 && Pn) return Pn.decode(U.subarray(S, S += t));
    const n = S + t, r = [];
    for (e = ""; S < n; ) {
      const s = U[S++];
      if ((s & 128) === 0) r.push(s);
  ...
  let Qs = new Float32Array(1), Ot = new Uint8Array(Qs.buffer, 0, 4);
  function ff() {
    ...
    return Ot[3] = t & 128 | (n >> 1) + 56, Ot[2] = (t & 7) << 5 | e >> 3, Ot[1] = e << 5, Ot[0] = 0, Qs[0];
  }
  new Array(4096);
  class We {
    constructor(e, n) {
  ...
  const zn = (t, e) => {
    t = t - 57344;
    let n = ee[t];
    n && n.isShared && ((ee.restoreStructures || (ee.restoreStructures = []))[t] = n), ee[t] = e, e.read = Hn(e);
  };
  te[rf] = (t) => {
  ...
  te[14] = (t) => re ? re[0].slice(re.position0, re.position0 += t) : new We(t, 14);
  te[15] = (t) => re ? re[1].slice(re.position1, re.position1 += t) : new We(t, 15);
  let lf = {
    Error,
    RegExp
  };
  ...
  te[258] = (t) => new Set(t);
  (te[259] = (t) => (W.mapsAsObjects && (W.mapsAsObjects = false, lt = true), t())).handlesRead = true;
  function Je(t, e) {
  ...
  const df = 1399353956;
  Fn.push((t, e) => {
    if (t >= 225 && t <= 255) return Je(Fe().prefixes[t - 224], e);
    if (t >= 28704 && t <= 32767) return Je(Fe().prefixes[t - 28672], e);
    if (t >= 1879052288 && t <= 2147483647) return Je(Fe().prefixes[t - 1879048192], e);
    if (t >= 216 && t <= 223) return Je(e, Fe().suffixes[t - 216]);
    if (t >= 27647 && t <= 28671) return Je(e, Fe().suffixes[t - 27639]);
    if (t >= 1811940352 && t <= 1879048191) return Je(e, Fe().suffixes[t - 1811939328]);
    if (t == df) return {
      packedValues: fe,
  ...
  function to(t) {
    let e = Ne, n = S, r = Jt, s = yt, o = Kt, i = ge, a = re, c = new Uint8Array(U.slice(0, Ne)), u = ee, f = W, l = bt, d = t();
    return Ne = e, S = n, Jt = r, yt = s, Kt = o, ge = i, re = a, U = c, bt = l, ee = u, W = f, ie = new DataView(U.buffer, U.byteOffset, U.byteLength), d;
  }
  function Nn() {
  ...
  let Vn, ro;
  const rn = typeof globalThis == "object" && globalThis.Buffer, At = typeof rn < "u", bn = At ? rn.allocUnsafeSlow : Uint8Array, ts = At ? rn : Uint8Array, ns = 256, rs = At ? 4294967296 : 2144337920;
  let mn, m, Z, p = 0, Ue, ne = null;
  ...
  class so extends mt {
    constructor(e) {
      ...
      this.mapEncode = function(y, j) {
        ...
        if (m || (m = new bn(8192), Z = new DataView(m.buffer, 0, 8192), p = 0), Ue = m.length - 10, Ue - p < 2048 ? (m = new bn(m.length), Z = new DataView(m.buffer, 0, m.length), Ue = m.length - 10, p = 0) : j === is && (p = p + 7 & 2147483640), n = p, c.useSelfDescribedHeader && (Z.setUint32(p, 3654940416), p += 3), i = c.structuredClone ? /* @__PURE__ */ new Map() : null, c.bundleStrings && typeof y != "string" ? (ne = [], ne.size = 1 / 0) : ne = null, r = c.structures, r) {
          if (r.uninitialized) {
            let C = c.getShared() || {};
        ...
        if (s && (s = false), o = r || [], h = v, e.pack) {
          ...
          if (A.values = [], A.encoder = c, A.maxValues = e.maxPrivatePackedValues || (v ? 16 : 1 / 0), A.objectMap = v || false, A.samplingPackedValues = d, Bt(y, A), A.values.length > 0) {
            m[p++] = 216, m[p++] = 51, xe(4);
            let C = A.values;
  ...
  function Bt(t, e) {
    switch (typeof t) {
      case "string":
        ...
        break;
      case "object":
        if (t) if (t instanceof Array) for (let r = 0, s = t.length; r < s; r++) Bt(t[r], e);
        else {
          let r = !e.encoder.useRecords;
          for (var n in t) t.hasOwnProperty(n) && (r && Bt(n, e), Bt(t[n], e));
        }
        break;
      case "function":
        console.log(t);
  ...
  Vn = [
    ...
    {
      getTag(t) {
        if (t.constructor === Uint8Array && (this.tagUint8Array || At && this.tagUint8Array !== false)) return 64;
      },
      encode(t, e, n) {
        Wn(t, n);
      }
    ...
    we(86, 8),
    {
      encode(t, e) {
        ...
        if (r) {
          ...
          let s = r.slice(0);
          s.unshift(57344), s.push(new We(t.version, 1399353956)), e(s);
        } else e(new We(t.version, 1399353956));
      }
    }
  ];
  function we(t, e) {
    return !wf && e > 1 && (t -= 4), {
      ...
      encode: function(r, s) {
        ...
        s(At ? rn.from(a, i, o) : new Uint8Array(a, i, o));
      }
    };
  }
  function Wn(t, e) {
  ...
  class If extends it {
    constructor(e, n = {}) {
      ...
      s ? (r = Tc(n.initialValue), r = wc(r)) : r = en(), __privateSet(this, _t2, Me(`automerge-repo:dochandle:${this.documentId.slice(0, 5)}`));
      ...
      __privateSet(this, _e2, pt(i)), __privateGet(this, _e2).subscribe((a) => {
  ...
  }, { REQUESTING: Tt, READY: xn, UNAVAILABLE: as } = Cf, Of = "CREATE", Tf = "FIND", Rf = "REQUEST", Mf = "DOC_READY", jf = "AWAIT_NETWORK", Df = "NETWORK_READY", Rt = "UPDATE", Uf = "DELETE", $f = "DOC_UNAVAILABLE";
  class Bf extends it {
    constructor() {
      super(...arguments);
  ...
  class Qf extends lo {
    constructor({ handle: e, onLoadSyncState: n }) {
      ...
      __privateSet(this, _t6, Me(`automerge-repo:docsync:${r}`)), e.on("change", qn(() => __privateMethod(this, _Qf_instances, g_fn).call(this), this.syncDebounceRate)), e.on("ephemeral-message-outbound", (s) => __privateMethod(this, _Qf_instances, p_fn).call(this, s)), (async () => (await e.doc([
        xn,
        Tt
    ...
    beginSync(e) {
      const n = e.every((s) => __privateGet(this, _r6)[s] in [
        ...
        if (__privateSet(this, _a3, true), __privateMethod(this, _Qf_instances, u_fn).call(this), !(s === void 0 && n)) return s ?? en();
      });
  ...
  class tl extends it {
    ...
    async export(e) {
      const n = yn(e), s = await __privateMethod(this, _tl_instances, c_fn3).call(this, {
        documentId: n,
        isNew: false
      }).doc();
      if (s) return Ss(s);
  ...
  let ye = 0, Mt = null;
  function Ft() {
    return (Mt === null || Mt.byteLength === 0) && (Mt = new Uint8Array(_.memory.buffer)), Mt;
  }
  const il = typeof TextEncoder > "u" ? (0, module.require)("util").TextEncoder : TextEncoder;
  let Ht = new il("utf-8");
  const al = typeof Ht.encodeInto == "function" ? function(t, e) {
  ...
  function Ae(t, e, n) {
    ...
    if (i !== r) {
      ...
      const a = Ft().subarray(s + i, s + r), c = al(t, a);
  ...
  let jt = null;
  function b() {
    return (jt === null || jt.byteLength === 0) && (jt = new Int32Array(_.memory.buffer)), jt;
  }
  ...
  _o.decode();
  function he(t, e) {
    return t = t >>> 0, _o.decode(Ft().subarray(t, t + e));
  }
  function w(t) {
    ht === Oe.length && Oe.push(Oe.length + 1);
    const e = ht;
    return ht = Oe[e], Oe[e] = t, e;
  }
  let Dt = null;
  function Lt() {
    return (Dt === null || Dt.byteLength === 0) && (Dt = new Float64Array(_.memory.buffer)), Dt;
  }
  function Kn(t) {
    const e = typeof t;
...
${t.stack}` : r;
  ...
  class Se {
    ...
    merge(e) {
      try {
        const o = _.__wbindgen_add_to_stack_pointer(-16);
        Le(e, Se), _.automerge_merge(o, this.__wbg_ptr, e.__wbg_ptr);
        var n = b()[o / 4 + 0], r = b()[o / 4 + 1], s = b()[o / 4 + 2];
        if (s) throw E(r);
        return E(n);
      } finally {
    ...
    receiveSyncMessage(e, n) {
      try {
        const o = _.__wbindgen_add_to_stack_pointer(-16);
        Le(e, be), _.automerge_receiveSyncMessage(o, this.__wbg_ptr, e.__wbg_ptr, w(n));
        var r = b()[o / 4 + 0], s = b()[o / 4 + 1];
        if (s) throw E(r);
      } finally {
        _.__wbindgen_add_to_stack_pointer(16);
  ...
  const kn = Ye, uh = (t) => t.type === "peer", fh = (t) => t.type === "error", lh = "1";
...
`), _h = (t) => {
  ...
  class ph extends gh {
    ...
    connect(e, n) {
      !this.socket || !this.peerId ? (__privateGet(this, _n9).call(this, "connecting"), this.peerId = e, this.peerMetadata = n ?? {}) : (__privateGet(this, _n9).call(this, "reconnecting"), ve(e === this.peerId), this.socket.removeEventListener("open", this.onOpen), this.socket.removeEventListener("close", this.onClose), this.socket.removeEventListener("message", this.onMessage), this.socket.removeEventListener("error", this.onError)), __privateGet(this, _e9) || __privateSet(this, _e9, setInterval(() => {
        this.connect(e, n);
      }, this.retryInterval)), this.socket = new kn(this.url), this.socket.binaryType = "arraybuffer", this.socket.addEventListener("open", this.onOpen), this.socket.addEventListener("close", this.onClose), this.socket.addEventListener("message", this.onMessage), this.socket.addEventListener("error", this.onError), setTimeout(() => __privateMethod(this, _ph_instances, r_fn2).call(this), 1e3), this.join();
    }
    join() {
      ve(this.peerId), ve(this.socket), this.socket.readyState === kn.OPEN && this.send(yh(this.peerId, this.peerMetadata));
    }
    disconnect() {
  ...
  Eh = async function(t) {
    let e = st().find(t), n = ls($e(e.docSync()));
    function r(s) {
      ft(n, $e(s.doc));
    }
  ...
  br = {
    1: (t) => {
      t.version = 1, t.user = st().create().documentId;
    }
  };
  wt = hs("user-document-ids", {});
  ot = hs("current-username", null);
  mh = Yi(() => wt.value[ot.value || ""] || null);
  Ih = {
    get username() {
      return ot.value;
    },
  ...
  Ch = async function(t) {
    const e = wt.value;
    if (e[t]) throw vt.from("errors_name_user", "errors_message_already_exists");
    const n = st().create();
    await n.whenReady(), await yr(n, br);
    const r = st().find(n.docSync().user);
    await r.whenReady(), r.change((s) => {
      s.username = t;
    }), e[t] = n.documentId, wt.value = e, ot.value = t;
  };
  Oh = async function(t) {
    const n = wt.value[t];
    if (!n) throw vt.from("errors_name_user", "errors_message_invalid_credentials");
    const r = st().find(n);
    await r.whenReady(), await yr(r, br), ot.value = t;
  };
  Th = async function(t, e) {
    const n = wt.value, r = st().find(e);
    await r.whenReady(), await yr(r, br), n[t] = r.documentId, ot.value = t;
  };
})();
export {
  Ha as A,
